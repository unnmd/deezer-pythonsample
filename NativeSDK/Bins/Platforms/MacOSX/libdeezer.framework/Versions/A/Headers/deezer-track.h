 ...
 */
LIBDEEZER_API dz_track_metadata_t dz_track_metadata_get_type(dz_track_metadata_handle self);

/**
 * @brief Get the media track detailed infos from a track metadata handle.
 */
LIBDEEZER_API const dz_media_track_detailed_infos_t*  dz_track_metadata_get_format_header(dz_track_metadata_handle self);

/**
 * @brief Get the media track duration in milliseconds from a track metadata handle.
 */
LIBDEEZER_API dz_mseconds_t dz_track_metadata_get_duration(dz_track_metadata_handle self);
